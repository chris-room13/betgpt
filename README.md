...
This was built fast for a hackathin submission. It’s **not fully reproducible** or production-ready:
- Hard-coded bits, minimal error handling
- No guaranteed environment setup
- APIs can change; results may vary

Still, we wanted to **publish** what we have for transparency.
